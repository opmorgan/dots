...
reload_openbox() {
  ...
  sed -i "/window.inactive.label.text.color:/c\window.inactive.label.text.color:\ ${foreground:-#000000}" ~/.themes/active/openbox-3/themerc
  sed -i "/window.active.title.bg.color:/c\window.active.title.bg.color:\ ${foreground:-#000000}" ~/.themes/active/openbox-3/themerc
